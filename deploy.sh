...
jq -n "{type:\"$GCLOUD_TYPE\",project_id:\"$GCLOUD_PROJECT_ID\",private_key_id:\"$GCLOUD_PRIVATE_KEY_ID\",private_key:\"$GCLOUD_PRIVATE_KEY\",client_email:\"$GCLOUD_CLIENT_EMAIL\",client_id:\"$GCLOUD_CLIENT_ID\",auth_uri:\"$GCLOUD_AUTH_URI\",token_uri:\"$GCLOUD_TOKEN_URI\",auth_provider_x509_cert_url:\"$GCLOUD_AUTH_PROVIDER_X509\",client_x509_cert_url:\"$GCLOUD_CLIENT_X509\"}" > gcloud_auth.json
